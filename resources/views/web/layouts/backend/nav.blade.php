        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element">
                    <span><img alt="image" class="img-circle" src="{{ url('/static/web/backend/images/profile_small.jpg') }}" /></span>
            ...
            <li>
                <a href="#"><i class="fa fa-bars"></i> <span class="nav-label">文章管理</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a class="J_menuItem" href="/book">发布文章</a>
                    </li>
                    <li><a class="J_menuItem" href="/book/list">文章列表</a>
                    </li>
                    <li><a class="J_menuItem" href="table_jqgrid.html">评论管理</a>
                    </li>
                </ul>
            </li>

            <li>
                <a href="#"><i class="fa fa-bars"></i> <span class="nav-label">会员管理</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a class="J_menuItem" href="tags">会员列表</a>
                    </li>
                    <li><a class="J_menuItem" href="table_data_tables.html">访客访问明细</a>
                    </li>
                    <li><a class="J_menuItem" href="table_jqgrid.html">评论管理</a>
                    </li>
                </ul>
            ...
            <li>
                <a href="layouts.html"><i class="fa fa-bars"></i> <span class="nav-label">配置</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li><a class="J_menuItem" href="tags">标签</a>
                    </li>
